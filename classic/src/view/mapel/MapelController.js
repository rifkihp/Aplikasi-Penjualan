Ext.define('Admin.view.mapel.MapelController', {
    extend: 'Ext.app.ViewController',

    alias: 'controller.mapel',
    ...
    onLoadData: function(form) {
        ...
        if(form.idEdit) {
            form.getForm().load({
                waitMsg: 'Loading...',
                method: 'GET',
                url: './server/public/mapel/'+form.idEdit+'/load',
    ...
    onDeleteButtonClick: function(btn) {
        ...
        Ext.MessageBox.confirm('Konfirmasi', 'Yakin untuk hapus data yang dipilih?', function(btn,text) {
            if(btn=='yes') {
                ...
                Ext.Ajax.request({
                    method:'GET',
                    url: './server/public/mapel/'+gridpanel.idSelect+'/delete',
    ...
    onSaveButtonClick: function(btn) {
        ...
        Ext.MessageBox.confirm('Konfirmasi', 'Yakin untuk proses simpan data?', function(btn, text) {
            if(btn=='yes') {
                ...
                form.getForm().submit({
                    method:'POST',
                    url: './server/public/mapel/'+form.saveUrl,
                    waitMsg: 'Simpan...',
    ...
    onAddButtonClick: function(btn) {
        ...
        var gridpanel = this.getView().down('gridpanel'); 
        this.setCurrentView('mapel-edit', {
